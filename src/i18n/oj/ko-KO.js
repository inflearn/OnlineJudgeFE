export const m = {
  ...
  Where_is_the_input_and_the_output: '프로그램에서 입력과 출력은 어떻게 작동하나요?',
  ...
  What_is_the_meaning_of_submission_execution_time: 'submission execution time 란?',
  What_is_the_meaning_of_submission_execution_time_answer: '코테 시스템은 제출된 코드를 여러 테스트 케이스를 사용해 채점해. submission_execution_time 은 내가 제출한 코드가 올바르고 제한 시간 안에 실행이 완료된 경우 각 테스트 케이스에 사용된 최대 시간이에요',
  ...
  Java_specifications: 'Java specifications(자바 스팩)',
  ...
  About_presentation_error: '출력 형식 오류가 있나요?',
